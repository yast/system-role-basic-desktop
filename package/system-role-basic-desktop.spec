#
# spec file for package system-role-basic-desktop
#
...
#   https://github.com/yast/system-role-basic-desktop repository
#
...
Name:           system-role-basic-desktop
# xmllint (for validation)
BuildRequires:  libxml2-tools
# RNG validation schema
BuildRequires:  yast2-installation-control >= 4.0.0

Url:            https://github.com/yast/system-role-basic-desktop
AutoReqProv:    off
Version:        15.0.3
Release:        0
Summary:        Basic desktop role definition
License:        MIT
Group:          Metapackages
BuildRoot:      %{_tmppath}/%{name}-%{version}-build
Source:         %{name}-%{version}.tar.bz2
Provides:       installer_module_extension() = system-role-basic-desktop
Provides:       extension_for_product() = SLED

%description
Meta package for basic desktop role definition.
